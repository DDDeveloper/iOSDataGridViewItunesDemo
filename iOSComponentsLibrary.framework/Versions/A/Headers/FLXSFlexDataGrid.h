...
@property (nonatomic, strong) NSArray* selectionColor ;
 ...
 * applied if you explicitly replace the dataprovider using grid.dataProvider = newDataProvider;
 */	
...
-(NSString*)traceRows;
/**
 * A dictionary of all the filters. An item with null key maps to the 
 * filters at the root level. For nested hierarchical items, the parent object is the key.
 */		
-(NSMutableDictionary*)itemFilters;
/**
 * @private 
 * @param val
 * 
 ...
 * @param column		The dataField of the column to get the filter value for
 */
 ...
 * @private
 */
- (int)getRecursiveOpenItemCount:(NSObject *)children nextLevel:(FLXSFlexDataGridColumnLevel *)nextLevel;
/**
