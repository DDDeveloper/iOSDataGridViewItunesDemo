...
@property (nonatomic, strong) FLXSFlexDataGridColumnLevel* parentLevel;
 ...
 */
- (BOOL)areAllSelected:(NSObject *)items checkLength:(BOOL)checkLength;
 ...
 */
- (NSObject *)getItemFromKey:(id)itemKey flat:(NSObject *)flat;
 ...
 */
- (BOOL)selectAll:(BOOL)select dispatch:(BOOL)dispatch provider:(NSObject *)provider subset:(NSArray *)subset useKeys:(BOOL)useKeys openItems:(BOOL)openItems;
 ...
 */	
-(NSString*)getSelectedKeysState:(NSObject*)allItems;
 ...
 */
- (BOOL)areAnySelected:(NSObject *)itemsToCheck recursive:(BOOL)recursive;
 ...
 */
- (BOOL)setSelectedItemsBasedOnSelectedField:(NSObject *)items parent:(NSObject *)parent openItems:(BOOL)openItems;
...
-(float)getNumChildren:(NSObject*)item;
