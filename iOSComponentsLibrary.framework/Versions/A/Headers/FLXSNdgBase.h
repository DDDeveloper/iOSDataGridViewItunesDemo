...
@property (nonatomic, strong) UIView* dropIndicator;
...
//todo sal - v1.2 longtouchgesture will do right click
...
- (void)showToaster:(NSString *)message toasterPosition:(NSString *)toasterPosition animationDuration:(float)animationDuration visibleDuration:(float)visibleDuration moveAnimate:(BOOL)moveAnimate fadeAnimate:(BOOL)fadeAnimate;
