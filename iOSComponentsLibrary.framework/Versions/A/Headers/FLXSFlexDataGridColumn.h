 ...
 * If the icon is dynamic, use the dataField to specify the url instead.
 * * [Style(name="icon")]
 */
...
- (NSString *)defaultIconFunction:(UIView <FLXSIFlexDataGridCell> *)cell state:(NSString *)state;
