...
- (BOOL)getObjectStack:(NSObject *)itemToFind stackSoFar:(NSMutableArray *)stackSoFar useItemKeyForCompare:(BOOL)useItemKeyForCompare flat:(NSObject *)flat level:(FLXSFlexDataGridColumnLevel *)level;
...
- (void)setChildData:(NSObject *)item children:(NSObject *)children level:(FLXSFlexDataGridColumnLevel *)level totalRecords:(int)totalRecords useSelectedKeyField:(BOOL)useSelectedKeyField;
...
- (float)addToExpandingPositions:(NSMutableArray *)array parentRowIndex:(int)parentRowIndex item:(NSObject *)item heightSoFar:(float)heightSoFar level:(FLXSFlexDataGridColumnLevel *)level parent:(NSObject *)parent rowType:(int)rowType;
