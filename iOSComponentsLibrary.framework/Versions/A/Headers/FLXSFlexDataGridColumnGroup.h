...
@property (nonatomic, strong) FLXSFlexDataGridColumnGroup* parentGroup;
@property (nonatomic, strong) NSMutableArray* columnGroups;
@property (nonatomic, strong) FLXSFlexDataGridColumn* startColumn;
@property (nonatomic, strong) FLXSFlexDataGridColumn* calculatedStart;
@property (nonatomic, strong) FLXSFlexDataGridColumn* calculatedEnd;
@property (nonatomic, strong) NSMutableArray* columns;
@property (nonatomic, strong) FLXSFlexDataGridColumn* endColumn;
/**
...
@property (nonatomic, strong) FLXSFlexDataGridColumn* collapseStateColumn;
/**
...
@property (nonatomic, readonly) FLXSFlexDataGridColumnGroup* rootGroup;
/**
